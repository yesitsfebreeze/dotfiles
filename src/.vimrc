...
inoremap <expr> <S-F12> col('.')>1 ? "\<Esc>\<Right>" : "\<Esc>"
inoremap <silent> <ESC> <Nop>
nnoremap <silent> <Esc> :startinsert<CR>
vnoremap <silent> <Esc> <Esc>:startinsert<CR>
onoremap <silent> <Esc> <Esc>:startinsert<CR>
snoremap <silent> <Esc> <Esc>:startinsert<CR>
cnoremap <silent> <Esc> <C-c>:startinsert<CR>
